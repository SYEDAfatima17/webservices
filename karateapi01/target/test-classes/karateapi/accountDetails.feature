Feature: Fetching Account Details

  Scenario: Testing the GET one Account Details
 ...
 Scenario: Testing the GET ALL Account Details
    Given url 'http://localhost:5000/api/v1/resources/accounts/all'
    When method GET
    Then status 200
